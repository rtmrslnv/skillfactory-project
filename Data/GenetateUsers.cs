...
namespace AwesomeNetwork.Data
{
    ...
    {
        public readonly string[] maleNames = new string[] { "Артем", "Данил", "Евгений", "Михаил", "Кузьма", "Алексей", "Иван", "Владимир", "Максим", "Никита" };
        public readonly string[] femaleNames = new string[] { "Ева", "Жанна", "Юлия", "Елена" };
        public readonly string[] lastNames = new string[] { "Иванов", "Петров", "Сергеев", "Николавев", "Алексеев" };
